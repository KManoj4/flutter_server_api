...
class _GroupNameListScreenState extends State<GroupNameListScreen> {
  ...
  getAllGroupName() async {
    ...
    try {
      String url = 'http://192.168.132.173:3051/getGroupNameDetails';
  ...
  void _save() async {
    ...
    String url = 'http://192.168.132.173:3051/api/storeGroupNameDetails';
  ...
  void _update(int groupNameId) async {
    ...
    String url = 'http://192.168.132.173:3051/api/updateGroupName?id=$groupNameId&group_name_col=$tmpGroupNameCol';
  ...
  void _deleteGroupName(groupNameId) async{
    ...
    String url = 'http://192.168.132.173:3051/api/deleteGroupName?id=$groupNameId';
